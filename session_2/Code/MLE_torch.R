...
# column vector of ture coeffs 1 and 1.8
...
LogLik <- function(beta, tvars) {
  ...
  # this is the log likelihood (chain rule on poisson pdf)
...
LogLikGrad <- function(beta) {
  ...
  # defineing the loss function
  loss <- LogLik(beta_ad, tvars)
  # first element of `autograd_grad` is the gradient of the loss with respect to
  # `beta_ad`
