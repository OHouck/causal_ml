...
# Last Edited: Dec 07, 2023 by Ozzy Houck

# Ozzy Change: added loss function and objective function (y_pred_func)

makeLam = function(dat,dnn, loss_func, y_pred_func, arch=c(5,5),NEPOCH=200){
