...
# Last Edited: Dec 7, 2023 by Ozzy Houck
# and provides all components needed for inference

# OH changes, added loss function and objective function (y_pred_func)


proc_res = function(dat,dnn,lproj,H, loss_func, y_pred_func){
